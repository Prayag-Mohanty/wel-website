...
COURSES = [
    {
        ...
        "staff": [
            ("Mahesh Ashok Bhaganagare", "Technical Officer", "assets/img/people/mahesh-bhaganagare.jpg"),
            ("Amit Shetye", "Sr. Technical Superintendent", "assets/img/people/amit-shetye.jpg"),
            ("Sadanand Sahadev Sawant", "Sr. Mechanic", "assets/img/people/sadanand-sawant.jpg"),
            ("Mangesh U. Ingle", "Sr. Project Assistant", "assets/img/people/mangesh-ingle.jpg"),
            ("Sandhya Samadhan Birare", "Lab Attendant", "assets/img/people/sandhya-birare.jpg"),
        ],
    ...
    },
    {
        ...
        "resource_note": "",
        "staff": [
            ("Maheshwar Mangat", "Sr. Technical Superintendent", "assets/img/people/maheshwar-mangat.jpg"),
            ("Suraj Suresh Sarfare", "Junior Mechanic", "assets/img/people/suraj-sarfare.jpg"),
            ("Sunil Sheshrao Raut", "Project Attendant", "assets/img/people/sunil-raut.jpg"),
            ("Vijay Vilas Patil", "Project Assistant", "assets/img/people/vijay-patil.jpg"),
        ],
        "schedule": None,
    ...
    },
    {
        ...
        "staff": [
            ("Mahesh Ashok Bhaganagare", "Technical Officer", "assets/img/people/mahesh-bhaganagare.jpg"),
            ("Ankur Agarwal", "Jr. Technical Superintendent", "assets/img/people/ankur-agarwal.jpg"),
            ("Sadanand Sahadev Sawant", "Sr. Mechanic", "assets/img/people/sadanand-sawant.jpg"),
            ("Mangesh U. Ingle", "Sr. Project Assistant", "assets/img/people/mangesh-ingle.jpg"),
            ("Sandhya Samadhan Birare", "Lab Attendant", "assets/img/people/sandhya-birare.jpg"),
        ],
